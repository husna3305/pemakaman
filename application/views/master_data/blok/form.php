                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="blok" name='blok' required value="<?= isset($row)?$row->blok:''?>" maxlength="2" <?=$disabled?> onkeypress="" style="text-transform:uppercase">
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      methods: {
        submitForm: function(el) {
          ...
          if ($('#'+form_name).valid()) // check if form is valid
          {
            ...
            <?php if (isset($row)) { ?>
              values.append('blok_lama', '<?= $row->blok ?>');
            <?php } ?>
            $.ajax({
              beforeSend: function() {
