                ...
                <div class="card-body">
                  <div class="box-body">
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Nama Suku (Latin) <span class='required'>*</span></label>
                          <div class="form-input">
                          <input type="text" class="form-control" id="nama_suku_latin" name='nama_suku_latin' required value="<?= isset($row)?$row->nama_suku_latin:''?>" <?=$disabled?> onkeypress="" style="text-transform:uppercase">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Nama Suku (Mandarin) <span class='required'>*</span></label>
                          <div class="form-input">
                          <input type="text" class="form-control" id="nama_suku_mandarin" name='nama_suku_mandarin' required value="<?= isset($row)?$row->nama_suku_mandarin:''?>" <?=$disabled?> onkeypress="" style="text-transform:uppercase">
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      methods: {
        submitForm: function(el) {
          ...
          if ($('#'+form_name).valid()) // check if form is valid
          {
            ...
            <?php if (isset($row)) { ?>
              values.append('id_suku', '<?= $row->id_suku ?>');
            <?php } ?>
            $.ajax({
              beforeSend: function() {
